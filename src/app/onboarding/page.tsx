  ...
  return (
    <main className="setup-v2-page">
      <header className="setup-v2-header">
        <Link href="/" className="marketing-brand"><span className="marketing-brand-mark"><CarFront size={19}/></span><span><strong>AutoParts</strong><small>CRM</small></span></Link>
      ...
      <div className="setup-v2-shell">
        <aside className="setup-v2-progress">
          ...
          <div className="setup-v2-note"><strong>O que será criado</strong><span>Matriz, horário comercial, estoque principal e permissões do proprietário.</span></div>
        </aside>

        <section className="setup-v2-main">
          <div className="setup-v2-title"><span className="overline-v2">Workspace</span><h2>Dados da empresa</h2><p>Complete somente o necessário para começar.</p></div>
